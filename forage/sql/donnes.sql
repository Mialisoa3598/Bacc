...
(1, 1, '2026-01-02'),  -- Demande1 acceptée
(1, 3, '2026-01-05'),  -- Demande1 commencée
(2, 1, '2026-01-16'); -- Demande2 acceptée

INSERT INTO t_devis (date, id_type_devis, id_demande) VALUES
('2026-01-03', 1, 1),  -- Devis étude terrain pour Demande1
('2026-01-06', 2, 1),  -- Devis forage pour Demande1
('2026-01-17', 1, 2);  -- Devis étude terrain pour Demande2

INSERT INTO t_detail_devis (libelle, montant, id_devis) VALUES
('Main d''oeuvre étude', 200000, 1),
('Transport étude', 50000, 1),
('Forage 50m', 1500000, 2),
('Matériel forage', 300000, 2),
('Main d''oeuvre forage', 500000, 2),
('Main d''oeuvre étude', 150000, 3),
('Transport étude', 50000, 3);